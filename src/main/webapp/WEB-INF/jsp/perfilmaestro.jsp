<%-- 
    Document   : perfilmaestro
    Created on : 27/05/2021, 05:05:13 PM
    Author     : maria
--%>
...
<html>
	...
	<link rel="stylesheet" href="styless.css" />
     <link rel="stylesheet" href="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/styles/kendo.common-fiori.min.css" />
    <link rel="stylesheet" href="styles/kendo.highcontrast.min.css" />
    <link rel="stylesheet" href="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/styles/kendo.default.mobile.min.css" />
...
<script src="https://code.jquery.com/jquery-1.9.1.min.js"></script>
 <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.2.16/angular.js"></script>
    ...
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/jquery.min.js"></script>
      
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/kendo.all.min.js"></script>
       <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/jquery.min.js'/>"></script>
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/kendo.all.min.js'/>"></script>
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/kendo.es-MX.js'/>"></script>
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/pooper.min.js'/>"></script>
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/bootstrap.min.js'/>"></script>
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/all.min.js'/>"></script>
    <script src="c:/Users/frijo/Documents/8vo.%20Cuatrimestre/js/jquery.min.js"></script>
...
<IMG SRC="logo3.png" WIDTH="160px" HEIGTH="40px">
<!--     <div id="configurator-wrap" class="col-sm-9 hidden-xs">
    ...
    <div id="example" class="container">
            ...
            <ul id="menu">
                ...
                <li><a href="#foto">Editar Foto</a></li>
		 <li><a href="examen.html">Crea tú Test</a></li>		          
</ul>

            <div class="row clearfix">
              <div class="col-lg-4">

                      <h2 class="ra-well-title">&nbsp;</h2>
                      <div class="row"><div class="col-lg-7 col-sm-2"></div>
                      </div>
                <label class="control-label col-sm-4" for="name">
				  <div class="form-horizontal form-widgets col-sm-6">
                <table width="685" height="1289" border="0" align="center" bgcolor="#A0D8F5" opacity=".5">
                  <tr>
                    <td width="752"><div align="center">
                      <table width="205" height="1132" border="0" align="left" bgcolor="#A0D8F5">
                        <tr>
                          <td width="359"><div class="col-lg-5 col-sm-2"> 
                      ...
                      <p><span class="ra-well-title Estilo2 Estilo4"><span class="ra-well-title Estilo2"><strong>Editar Perfil<br>
                        <br>
                        </strong></span></span>
                      <div class="col-sm-8 col-md-6 Estilo4">
                        <div align="center">
                         <table width="301" height="656" border="0">
                           <tr>
                             <td>Nombre:</td>
                             <td><input name="Input" id="name" value="Johnatan Dodsworth" /></td>
                           </tr>
                           <tr>
                             <td>Fecha de Nacimiento:</td>
                             <td><input name="date" type="date" value="10/09/1979" /></td>
                           </tr>
                           <tr>
                             <td>Genero:</td>
                             <td><select name="select3" id="gender">
                           ...
                           <tr>
                             <td>Idioma</td>
                             <td><select name="select" id="language">
                           ...
                           <tr>
                             <td>Ocupación:</td>
                             <td><input name="Input2" id="occupation" size="20" placeholder="Instructor" /></td>
                           </tr>
                           <tr>
                             <td height="99"><p>Hablidades</p>
                             <p>&nbsp;</p>
                             <p>Experiencia:</p></td>
                             <td><p>
                               <select name="select2" multiple id="skills">
                                 <option>C</option>
                                 <option>C++</option>
                             ...
                             <p>&nbsp;</p>
                             <p>
                               <input name="number" type="number" id="experience" value="4" />
</p></td>
                           </tr>
                         </table>
                        </div>
				      ...
				      <div class="col-sm-01">
					  <center>
					    <table width="435" height="229" border="0">
                          <tr>
                            <td><center>
                              <p>
                                <textarea name="textarea" id="bio"></textarea>
                              </p>
                              <p>&nbsp;</p>
                              <table width="255" height="81" border="0">
                                <tr>
                                  <td> <div id="imageEditor"></div>
<script>
            ...
            $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "Descripcion", title:"Descripcion del curso"}]
                      ...
                      <table width="672" height="146" border="0">
                        <tr>
...
<br>
            ...
            <footer>Copyright &copy; <script>document.write(new Date().getFullYear());</script> <a href="https://www.telerik.com/">B1 SOFT</a>. All rights reserved.</footer>
        </div>
