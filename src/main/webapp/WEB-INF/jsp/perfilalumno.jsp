...
<html>
 <head>
    ...
    <link rel="stylesheet" href="http://kendo.cdn.telerik.com/2021.2.511/styles/kendo.highcontrast.min.css" />
    <link rel="stylesheet" href="http://kendo.cdn.telerik.com/2021.2.511/styles/kendo.highcontrast.mobile.min.css" />
...
<body>
    <header>
        <div class="container" class="row">
            ...
            <a h1 class="col-sm-3 hidden-sm"  href="indexusu.htm"><center><img src="B1_Soft_Negro_con_Sombra.png" width="130px" height="30"></center></a></h1>
...
>>>>>>> 63c720dec72afd54ecfcd01f4919eaf981f03937
                            ...
                            <section class="well">
                                ...
                                <div class="form-horizontal form-widgets col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="birthday">Fecha de
                                            nacimiento:</label>
                                        <div class="col-sm-8 col-md-6">
                ...
                <div class="col-lg-4">-->
                        ...
                        <footer>| © Servicios Tecnológicos B1 SOFT S.A. de C.V. &copy;
                            <script>document.write(new Date().getFullYear());</script> <font color="#ffffff"><a
