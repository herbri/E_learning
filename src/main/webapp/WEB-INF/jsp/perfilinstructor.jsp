...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .navbar{background-color: #009efd !important;}
        </style>
    </head>
    <body>
        <div align="center">         
            ...
            <div id="example">
                ...
                <ul id="menu">
                    ...
                    <li><a href="cursos.htm">Ver Cursos</a></li>
                    <li><a href="#foto">Editar Foto</a></li>
                    <li><a href="examen.htm">Crea tú Test</a></li>          
                </ul>
                    ...
                    <div class="col-lg-4">
                        ...
                        <label class="control-label col-sm-4" for="name">
                            <div class="form-horizontal form-widgets col-sm-6">
                                <table width="685" height="1289" border="0" align="center" bgcolor="#A0D8F5" opacity=".5">
                                    <tr>
                                        <td width="752"><div align="center">
                                                ...
                                                <div align="left">
                                                    <table width="457" height="656" border="0">
                                                        <tr>
                                                            ...
                                                            <td width="289"><input name="Input" id="name" value="Johnatan Dodsworth" /></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <p></p>
                                            <table width="536" height="146" border="0">
                                                <tr>
                                                    <td width="530"><div id="grid"></div></td>
                                                </tr>
                                            </table>
                                            <p align="center">
                                        <td height="42">                                  
                                ...
                                <div align="center"><button class="k-button k-state-default">Cancelar</button>
