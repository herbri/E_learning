<%-- 
    ...
    Created on : 31/05/2021, 06:08:17 PM
    Author     : Jose
--%>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
     <a class="navbar-brand" href="index.html"><center><img src="B1_Soft_Blanco_con_Sombra.png" width="120px" height="30"></a></center>
        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin">
              ...
              <div class="form-label-group">
                <input type="Nombre" id="inputNombre" class="form-control" placeholder="Nombre del Usuario" required>
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" onclick="alert('La llave de recuperación a sido enviada al correo electrónico que proporcionaste.');">Enviar Correo de Recuperación    </button>
			    ...
			    <span class="Estilo1"><a href="login.html" class="Estilo1">Regresar</a>
			    </button>
			    </span>
            </form>
