      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
           ...
           <span class="Estilo1"><a href="recuperar contraseña.html" class="Estilo1">Olvide mi contraseña</a>
           </button>
            </span>
            </form>
            <small class="d-inline-block text-muted mt-5">Todos los
							derechos reservados | © 2021 B1 SOFT</small>
          </div>
        </div>
      </div>
    </div>
