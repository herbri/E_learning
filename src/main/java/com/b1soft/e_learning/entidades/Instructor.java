...
public class Instructor implements Serializable {
    ...
    public Instructor(int id_instructor, String nombres, String apellidos, int edad, String gradestudios, String especialidad, String cedula, String email, String password, String confirmpassword) {
    ...
    public void setId_instructor(String id) {
