<%-- 
    Document   : indexusu
    Created on : 9/06/2021, 04:42:40 PM
    Author     : Jose
--%>
    ...
    <body background="Imagen2.jpeg">
        ...
        <div class="container">
            ...
            <header class="jumbotron my-4">
                <h1 class="display-3">Bienvenido "Usuario"</h1>
                <p class="lead">A tu plataforma de aprendizaje proporcionada por B1 Soft Latam</p>
                <a class="btn btn-primary btn-lg" href="perfilalumno.htm">Personaliza tu perfil!</a>
            </header>
            <!-- Page Features-->
            ...
            <div class="card-footer" align="center"><a class="btn btn-primary" href="areasgeneral.htm">Da Click para dar un vistazo a todas las áreas</a></div>
        <br>
