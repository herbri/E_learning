<%-- 
    Document   : areasgeneral
    Created on : 9/06/2021, 03:29:34 PM
    Author     : Jose
--%>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <br>
                                <center><h2 class="card-title">Área 1: Físico Matemático</h2>
                                    <br>
                                ...
                                <br>
                               <a type="button" class="btn btn-outline-success" a href="area1.htm">Comienza Ahora!!! →</a></center>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <br>
                                <center><h2 class="card-title">Área 2: Ciencias Biologicas y de la salud</h2>
                                <br>
                                <p class="card-text">El área 2 del conocimiento abarca todas las ciencias naturales. Involucra el estudio de los seres vivos, sus cambios y procesos. Adicionalmente, involucra temas en materia de salud de los mismos, es decir, enfermedades, padecimientos y soluciones de mejora.
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <br>
                                <center><h2 class="card-title">Área 3: Ciencias Sociales</h2>
                                <br>
                                ...
                                <br>
                                <a type="button" class="btn btn-outline-success" href="sociales.htm">Comienza Ahora!!! →</a></center>
                            </div>
                        </div>
                    </div>
                    <!--<div class="card-footer text-muted">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <br>
                                <center><h2 class="card-title">Área 4: Artes y humanidades</h2>
                                <br>
